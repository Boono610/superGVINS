...
/**
 * @param features: 259 x N matrix, each column is a feature, the first row is the score, the second row is the x coordinate, the third row is the y coordinate, the fourth row is the orientation, and the rest rows are the descriptor.
 */
